...
import { SnsLinksSection } from "../../_components/sns-links-section";

export default function EditSnsPage() {
  ...
  return (
    <div>
      <PageHeader title="SNSリンク" backHref="/settings" />
      <div className="px-4 py-4 space-y-6">
        <SnsLinksSection form={form} update={update} />
