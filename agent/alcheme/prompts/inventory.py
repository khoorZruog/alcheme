...
9. **hex_color**: 商品の代表色の推定HEXカラーコード（例: "#C24B5A", "#8B4513"）
   - パッケージ色ではなく**中身の色（実際の発色・テクスチャーの色）**を推定すること
   - color_description と矛盾しないこと
   - 推定が困難な場合（スキンケア、透明系、無色系）は null とする
   - フォーマット: "#" + 6桁の16進数大文字 (例: "#FF5733")
10. **texture**: 以下のいずれか — マット, ツヤ, サテン, シマー, クリーム, パウダー, リキッド
11. **estimated_remaining**: 残量推定 — "100%", "80%", "60%", "40%", "20%", "ほぼ空"
12. **confidence**: 識別確信度 — "high", "medium", "low"
